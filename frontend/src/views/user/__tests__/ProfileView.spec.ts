...
describe('ProfileView', () => {
  ...
  it('renders the simplified single-column profile shell without separate stat cards', async () => {
    const wrapper = mount(ProfileView, {
      global: {
        stubs: {
          ...
          ProfileWeChatBotCard: { template: '<div data-testid="profile-wechat-bot-card" />' },
    ...
    expect(wrapper.get('[data-testid="profile-shell"]').html()).toContain('profile-wechat-bot-card')
