...
describe('UseKeyModal', () => {
  ...
  it('renders GPT-5.6 Sol and goals in the default OpenAI Codex config', () => {
    const wrapper = mount(UseKeyModal, {
      props: {
        show: true,
        apiKey: 'sk-test',
  ...
  it('renders GPT-5.6 Sol and goals in the default OpenAI Codex WebSocket config', async () => {
    const wrapper = mount(UseKeyModal, {
      props: {
        show: true,
        apiKey: 'sk-test',
