...
const syncFormFromAccount = (newAccount: Account | null) => {
  ...
  openAISmartUserAgentEnabled.value =
    newAccount.platform === 'openai' && credentials?.smart_user_agent_enabled === true
...
const handleSubmit = async () => {
  ...
  try {
    ...
    if (
      ...
      applyOpenAISmartUserAgent(newCredentials, openAISmartUserAgentEnabled.value, 'edit')
      updatePayload.credentials = newCredentials
    }
