export default {
    settings: {
      ...
      wechatBot: {
        title: '微信 iLink 机器人',
        description: '监控用户各自授权的 iLink 会话，并从 Sub2API 网站发送管理员通知。',
        worker: '后台任务',
        running: '运行中',
        stopped: '已停止',
        connectedUsers: '已连接用户',
        deliveryOpenUsers: '窗口可用用户',
        pending: '待发消息',
        ...
        message: '通知内容',
        messagePlaceholder: '输入管理员通知内容',
        sendBroadcast: '加入通知队列',
        broadcastQueued: '已加入 {count} 条通知。',
        broadcastFailed: '管理员通知入队失败。',
      },
      authSourceDefaults: {
        title: '认证来源默认值',
