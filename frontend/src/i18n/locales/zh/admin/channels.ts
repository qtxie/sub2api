export default {
    ...
    channels: {
      ...
      emptyModelsInPricing: '请至少为 {platform} 添加一条模型定价',
    ...
    subscriptions: {
      ...
      form: {
        ...
        validityDays: '有效期（天）',
        adjustDays: '调整天数',
        quotaBoostMonthlyLimit: '每月日额度翻倍次数'
      },
      selectUser: '选择用户',
      selectGroup: '选择订阅分组',
      ...
      quotaBoost: '额度翻倍',
      quotaBoostPolicy: '日额度翻倍策略',
      quotaBoostHint: '每个自然月允许 0 至 31 次，设为 0 表示关闭。',
      quotaBoostUsage: '已使用 {used}/{limit} 次翻倍',
      quotaBoostCurrentUsage: '当前自然月已使用 {used} 次。',
      quotaBoostActive: '今日 2 倍额度已启用',
      quotaBoostLimitInvalid: '每月次数必须是 0 至 31 的整数',
      quotaBoostPolicySaved: '日额度翻倍策略已保存',
      failedToSaveQuotaBoostPolicy: '保存日额度翻倍策略失败',
