export default {
    ...
    subscriptions: {
      ...
      form: {
        ...
        validityDays: '有效期（天）',
        adjustDays: '调整天数',
        quotaBoostMonthlyLimit: '每月 2 倍额度可用次数'
      },
      selectUser: '选择用户',
      selectGroup: '选择订阅分组',
      ...
      quotaBoostHint: '每个自然月可启用 0 到 31 次。设为 0 表示禁用。',
      quotaBoostUsage: '已用 {used}/{limit} 次',
      quotaBoostCurrentUsage: '本月已使用 {used} 次。',
      quotaBoostActive: '今日 2 倍已启用',
      quotaBoostLimitInvalid: '每月可用次数必须是 0 到 31 的整数',
