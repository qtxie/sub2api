export default {
  ...
  profile: {
    ...
    wechatBot: {
      title: '微信机器人',
      description: '接收账户通知、查询余额，并通过指定 API Key 与模型对话。',
      unavailable: '微信机器人服务当前不可用。',
      connectTitle: '连接你的微信',
      connectHint: '请使用需要接收通知的微信扫码。该 iLink 会话仅属于当前 Sub2API 账户。',
      connect: '连接微信',
      qrAlt: '个人微信机器人登录二维码',
      qrHint: '使用微信扫码，并在手机上确认连接。',
      ...
      loginSuccess: '你的微信机器人已连接。',
      qrFailed: '生成登录二维码失败。',
      pollFailed: '查询微信登录状态失败。',
      connected: '已连接',
      windowOpen: '通知发送窗口已开启',
      windowClosed: '向机器人发送消息以恢复通知',
      lastConnected: '最近连接：{time}',
      lastInbound: '最近收到消息：{time}',
      activateHint: '请打开微信中的 ClawBot 会话并发送任意消息，以提供会话上下文并开启 24 小时通知窗口。',
      enabled: '启用微信机器人',
      enabledHint: '统一控制微信通知和聊天功能。',
      proactiveDefaultOff: '管理员、余额和登录通知默认关闭；如需使用，请在下方单独开启。',
      adminNotify: '管理员通知',
      balanceNotify: '余额不足通知',
      loginNotify: '登录通知',
      chatEnabled: 'API Key 聊天',
      chatHint: '普通微信消息将使用所选 API Key 和模型进行对话。',
      apiKey: 'API Key',
      selectKey: '选择 API Key',
      selectKeyRequired: '开启聊天前请选择可用的 API Key。',
      noKeys: '当前没有可用的 API Key。',
      model: '模型',
      test: '发送测试',
      testQueued: '测试通知已加入发送队列。',
      disconnect: '断开连接',
      disconnectTitle: '断开微信机器人',
      disconnectConfirm: '确定移除你的 iLink 登录、待发通知和微信机器人设置吗？',
      disconnected: '微信机器人已断开连接。',
      loadFailed: '加载微信机器人设置失败。',
      keysFailed: '加载 API Key 失败。',
      saveFailed: '保存微信机器人设置失败。',
      testFailed: '测试通知入队失败。',
      disconnectFailed: '断开微信机器人失败。',
    },
    avatar: {
      title: '资料头像',
