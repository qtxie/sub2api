export default {
  ...
  chat: {
    ...
    recentChats: '最近聊天',
    noHistory: '暂无聊天记录',
    loadOlderChats: '加载更早的聊天（{count}）',
    loadingOlderChats: '正在加载更早的聊天...',
    loadOlderFailed: '加载更早的聊天失败',
    showFewerChats: '收起',
    apiKey: 'API 密钥',
    ...
    chatSettings: '设置',
    systemPrompt: '系统提示词',
    systemPromptPlaceholder: '此聊天的可选指令',
    clearSystemPrompt: '清空系统提示词',
    done: '完成',
    collapseSidebar: '收起边栏',
    expandSidebar: '展开边栏',
    exportAll: '导出全部聊天',
    exportSuccess: '聊天导出已下载',
    exportFailed: '导出聊天失败',
    addAttachment: '添加附件',
    uploadImage: '上传图片',
    uploadFile: '上传文件',
    removeAttachment: '移除附件',
    attachmentOnlyMessage: '附件',
    tooManyAttachments: '最多可添加 {max} 个附件',
    readAttachmentFailed: '读取附件失败',
  ...
  imageStudio: {
    title: '图片工作室',
    description: '使用 GPT Image 2 创建图片',
    apiKey: 'API 密钥',
    model: '图片模型',
    selectApiKey: '选择允许生图的 API 密钥',
    prompt: '提示词',
    promptPlaceholder: '描述你希望创建的图片',
    size: '尺寸',
    pricePerImage: '每张图片价格',
    perImage: '/ 张',
    usageBasedPricing: '按实际用量计算',
    loadPricingFailed: '暂时无法获取价格信息',
    quality: '质量',
    qualityLow: '低',
    qualityMedium: '中',
    qualityHigh: '高',
    ...
    generate: '生成',
    generating: '生成中...',
    generatingImage: '正在创建图片',
    elapsedSeconds: '已用时 {seconds} 秒',
    generationFailed: '生成失败',
    retryGeneration: '重试',
    generated: '已生成 {count} 张图片',
    generateFailed: '图片生成失败',
    noImagesReturned: '生图请求已完成，但未返回图片',
    loadKeysFailed: '加载允许生图的 API 密钥失败',
    noEligibleKeys: '请创建属于允许生图分组的活动 API 密钥后再使用图片工作室。',
    emptyGallery: '生成的图片会显示在这里。',
    gallerySaveFailed: '图片已生成，但无法保存到当前浏览器。',
    galleryLoadFailed: '无法从当前浏览器加载图片图库。',
    clearGallery: '清空图库',
    reusePrompt: '复用提示词',
    download: '下载'
  },
