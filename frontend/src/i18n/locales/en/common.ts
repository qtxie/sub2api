export default {
  ...
  chat: {
    ...
    loadOlderChats: 'Load older chats ({count})',
    loadingOlderChats: 'Loading older chats...',
    loadOlderFailed: 'Failed to load older chats',
    ...
    loadModelsFailed: 'Failed to load supported models',
    copy: 'Copy',
    copied: 'Copied',
    ...
    systemPromptPlaceholder: 'Optional instructions for this chat',
    clearSystemPrompt: 'Clear system prompt',
    done: 'Done',
    collapseSidebar: 'Collapse sidebar',
    expandSidebar: 'Expand sidebar',
    exportAll: 'Export all chats',
    exportSuccess: 'Chat export downloaded',
    exportFailed: 'Failed to export chats',
    addAttachment: 'Add attachment',
    uploadImage: 'Upload image',
    uploadFile: 'Upload file',
    removeAttachment: 'Remove attachment',
    attachmentOnlyMessage: 'Attachment',
    tooManyAttachments: 'You can attach up to {max} files',
    readAttachmentFailed: 'Failed to read attachment',
  ...
  imageStudio: {
    ...
    apiKey: 'API Key',
    model: 'Image model',
    selectApiKey: 'Select an image-enabled API key',
    prompt: 'Prompt',
    promptPlaceholder: 'Describe the image you want to create',
    size: 'Size',
    pricePerImage: 'Price per image',
    perImage: '/ image',
    usageBasedPricing: 'Calculated from actual usage',
    loadPricingFailed: 'Price information is unavailable',
    quality: 'Quality',
    qualityLow: 'Low',
    ...
    noImagesReturned: 'Image generation completed without returning an image',
    loadKeysFailed: 'Failed to load image-enabled API keys',
    noEligibleKeys: 'Create an active API key in a group that allows image generation to use Image Studio.',
    emptyGallery: 'Your generated images will appear here.',
    gallerySaveFailed: 'Image generated, but could not be saved to this browser.',
    galleryLoadFailed: 'Failed to load the image gallery from this browser.',
