export default {
    settings: {
      ...
      wechatBot: {
        ...
        description: 'Monitor user-owned iLink sessions and send administrator notifications from the Sub2API website.',
        worker: 'Worker',
        running: 'Running',
        stopped: 'Stopped',
        connectedUsers: 'Connected users',
        deliveryOpenUsers: 'Open windows',
        ...
        message: 'Message',
        messagePlaceholder: 'Enter the administrator notification',
        sendBroadcast: 'Queue notification',
        broadcastQueued: '{count} notifications queued.',
        broadcastFailed: 'Failed to queue the administrator notification.',
      },
      authSourceDefaults: {
