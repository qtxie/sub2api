export default {
    accounts: {
      ...
      softModelMapping: 'Soft Model Mapping',
      softModelMappingDesc:
        'Try the right-hand model only after the left-hand model fails on this account. Unlike hard mapping, the first attempt still uses the original request model (then hard mapping if configured). Works even when global same-account model fallback is off.',
      softFallbackModel: 'Fallback model (on failure)',
      addSoftMapping: 'Add Soft Mapping',
