export default {
    ...
    channels: {
      ...
      emptyModelsInPricing: 'Please add at least one model pricing entry for {platform}',
    ...
    subscriptions: {
      ...
      form: {
        ...
        quotaBoostMonthlyLimit: 'Monthly 2x quota activations'
      },
      ...
      quotaBoost: '2x Quota',
      quotaBoostPolicy: 'Daily Quota Boost Policy',
      quotaBoostHint: 'Allow 0 to 31 activations per calendar month. Set 0 to disable.',
      quotaBoostUsage: '{used}/{limit} boosts used',
      quotaBoostCurrentUsage: '{used} activations have been used in the current month.',
      quotaBoostActive: '2x active today',
      quotaBoostLimitInvalid: 'Monthly activations must be a whole number from 0 to 31',
      quotaBoostPolicySaved: 'Daily quota boost policy saved',
      failedToSaveQuotaBoostPolicy: 'Failed to save daily quota boost policy',
