export default {
  ...
  profile: {
    ...
    wechatBot: {
      title: 'WeChat Bot',
      description: 'Receive account notifications, query your balance, and chat through a selected API key.',
      unavailable: 'The WeChat bot service is currently unavailable.',
      connectTitle: 'Connect your WeChat',
      connectHint: 'Scan with the WeChat account that should receive notifications. The iLink session belongs only to your Sub2API account.',
      connect: 'Connect WeChat',
      qrAlt: 'Personal WeChat bot login QR code',
      qrHint: 'Scan with WeChat and confirm the connection on your phone.',
      qrExpires: 'QR code expires at {time}',
      newQR: 'New QR code',
      qrStatus: {
        waiting: 'Waiting for scan',
        scanned: 'Scanned; confirm in WeChat',
        expired: 'QR code expired',
      },
      loginSuccess: 'Your WeChat bot is connected.',
      qrFailed: 'Failed to create the login QR code.',
      pollFailed: 'Failed to check the WeChat login status.',
      connected: 'Connected',
      windowOpen: 'Delivery window open',
      windowClosed: 'Send a message to reopen delivery',
      lastConnected: 'Last connected {time}',
      lastInbound: 'Last message received {time}',
      activateHint: 'Open the WeChat ClawBot conversation and send any message. This supplies the conversation context and opens the 24-hour delivery window.',
      enabled: 'Enable WeChat bot',
      enabledHint: 'This is the master switch for notifications and chat.',
      proactiveDefaultOff: 'Administrator, balance, and login notifications are off by default. Enable them below when needed.',
      adminNotify: 'Administrator messages',
      balanceNotify: 'Low-balance alerts',
      loginNotify: 'Login alerts',
      chatEnabled: 'API key chat',
      chatHint: 'Ordinary WeChat messages are sent to the selected key and model.',
      apiKey: 'API key',
      selectKey: 'Select an API key',
      selectKeyRequired: 'Select an available API key before enabling chat.',
      noKeys: 'No active API keys are available.',
      model: 'Model',
      test: 'Send test',
      testQueued: 'Test notification queued.',
      disconnect: 'Disconnect',
      disconnectTitle: 'Disconnect WeChat bot',
      disconnectConfirm: 'Remove your iLink login, queued notifications, and WeChat bot settings?',
      disconnected: 'WeChat bot disconnected.',
      loadFailed: 'Failed to load WeChat bot settings.',
      keysFailed: 'Failed to load API keys.',
      saveFailed: 'Failed to save WeChat bot settings.',
      testFailed: 'Failed to queue the test notification.',
      disconnectFailed: 'Failed to disconnect the WeChat bot.',
    },
    avatar: {
