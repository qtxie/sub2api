...
func (s *GatewayService) routingAccountIDsForRequest(ctx context.Context, groupID *int64, requestedModel string, platform string) []int64 {
	if groupID == nil || requestedModel == "" || !modelRoutingAppliesToTargetPlatform(platform) {
		// QC 质检流量可在无 model-routing 时强制短名单。
		return RestrictAccountIDsForQCProbe(ctx, platform, nil)
	}
	...
	// QC 质检流量：与既有路由求交（无交集时按 fallback 语义处理）。
...
func (s *GatewayService) listSchedulableAccounts(ctx context.Context, groupID *int64, platform string, hasForcePlatform bool) ([]Account, bool, error) {
	...
	if useMixed {
		...
		return applyQC(s.filterAccountsBySchedulingThreshold(ctx, filtered), useMixed, nil)
	}
...
func (s *GatewayService) isAccountInGroup(ctx context.Context, account *Account, groupID *int64) bool {
	...
	// Global QC burn-pool accounts may serve any group while probe routing is active.
