...
type OpenAIForwardResult struct {
	...
	// VideoInputImageCount tracks image inputs for Grok image-to-video billing.
...
type OpenAIGatewayService struct {
	...
	gatewayNotificationPublisher        atomic.Pointer[gatewayNotificationPublisherHolder]
...
// CloseOpenAIWSPool closes OpenAI background workers and idle WebSocket connections.
// 应在应用优雅关闭时调用。
