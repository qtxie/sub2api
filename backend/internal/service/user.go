...
type User struct {
	...
	// SessionStorageEnabled controls standalone user-session capture for this user.
	// It is intentionally independent from prompt audit and risk-control features.
