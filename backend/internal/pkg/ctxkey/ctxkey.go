...
const (
	...
	// UserDisplayName is the authenticated user's operator-facing identity.
	// API key auth prefers email and falls back to username.
	UserDisplayName Key = "ctx_user_display_name"
