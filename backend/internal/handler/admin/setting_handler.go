...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		FallbackModelsAnthropic:                                settings.FallbackModelsAnthropic,
		FallbackModelsOpenAI:                                   settings.FallbackModelsOpenAI,
		FallbackModelsGemini:                                   settings.FallbackModelsGemini,
		FallbackModelsAntigravity:                              settings.FallbackModelsAntigravity,
