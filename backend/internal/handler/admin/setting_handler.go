...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		OpenAIPriorityDominantEnabled:                          settings.OpenAIPriorityDominantEnabled,
		...
		OpenAIStickyFailbackRelapseWindowSeconds:               settings.OpenAIStickyFailbackRelapseWindowSeconds,
		OpenAIStickyFailbackCooldownIncrementSeconds:           settings.OpenAIStickyFailbackCooldownIncrementSeconds,
		OpenAIStickyFailbackCooldownMaxSeconds:                 settings.OpenAIStickyFailbackCooldownMaxSeconds,
		OpenAIStickyFailbackRecoveryFastCount:                  settings.OpenAIStickyFailbackRecoveryFastCount,
		OpenAIProductionTTFTFreshnessSeconds:                   settings.OpenAIProductionTTFTFreshnessSeconds,
