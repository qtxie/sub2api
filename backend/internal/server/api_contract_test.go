		...
		},
		{
			...
			setup: func(t *testing.T, deps *contractDeps) {
				...
				deps.settingRepo.SetAll(map[string]string{
					...
					"openai_sticky_prefer_higher_priority_enabled":                       "true",
					"openai_sticky_prefer_higher_priority_min_interval_seconds":          "15",
					"openai_sticky_failback_failure_cooldown_seconds":                    "120",
					"openai_previous_response_rebind_enabled":                            "true",
					"openai_previous_response_rebind_only_when_current_unhealthy":        "false",
				})
			},
			method:     http.MethodGet,
