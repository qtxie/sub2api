...
var auditSensitiveReads = map[string]string{
	...
	"GET /api/v1/admin/user-sessions":                    "admin.user_sessions.list",
	"GET /api/v1/admin/user-sessions/:id":                "admin.user_sessions.read",
	"GET /api/v1/admin/user-sessions/:id/export":         "admin.user_sessions.export",
	"GET /api/v1/admin/user-sessions/:id/blobs/:blob_id": "admin.user_sessions.blob.read",
}
...
var auditActionOverrides = map[string]string{
	...
	"DELETE /api/v1/admin/user-sessions/:id":                  "admin.user_sessions.delete",
}
