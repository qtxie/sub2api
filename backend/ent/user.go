...
type User struct {
	...
	// SessionStorageEnabled holds the value of the "session_storage_enabled" field.
	SessionStorageEnabled bool `json:"session_storage_enabled,omitempty"`
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case user.FieldTotpEnabled, user.FieldRestrictPublicGroups, user.FieldBalanceNotifyEnabled, user.FieldSessionStorageEnabled:
...
func (_m *User) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case user.FieldSessionStorageEnabled:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field session_storage_enabled", values[i])
			} else if value.Valid {
				_m.SessionStorageEnabled = value.Bool
			}
		default:
...
func (_m *User) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("session_storage_enabled=")
	builder.WriteString(fmt.Sprintf("%v", _m.SessionStorageEnabled))
	builder.WriteByte(')')
