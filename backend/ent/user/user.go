...
const (
	...
	// FieldSessionStorageEnabled holds the string denoting the session_storage_enabled field in the database.
	FieldSessionStorageEnabled = "session_storage_enabled"
...
var (
	...
	DefaultRpmLimit int
	// DefaultSessionStorageEnabled holds the default value on creation for the "session_storage_enabled" field.
	DefaultSessionStorageEnabled bool
)
...
// BySessionStorageEnabled orders the results by the session_storage_enabled field.
func BySessionStorageEnabled(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldSessionStorageEnabled, opts...).ToFunc()
}
