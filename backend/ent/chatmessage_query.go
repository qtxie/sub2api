...
func (_q *ChatMessageQuery) QueryConversation() *ChatConversationQuery {
...
func (_q *ChatMessageQuery) QueryUser() *UserQuery {
...
func (_q *ChatMessageQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *ChatMessageQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *ChatMessageQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *ChatMessageQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *ChatMessageQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *ChatMessageQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ChatMessageQuery) WithConversation(opts ...func(*ChatConversationQuery)) *ChatMessageQuery {
	query := (&ChatConversationClient{config: _q.config}).Query()
...
func (_q *ChatMessageQuery) WithUser(opts ...func(*UserQuery)) *ChatMessageQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ChatMessageQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*ChatMessage, error) {
	...
	if query := _q.withConversation; query != nil {
		if err := _q.loadConversation(ctx, query, nodes, nil,
			func(n *ChatMessage, e *ChatConversation) { n.Edges.Conversation = e }); err != nil {
			return nil, err
		}
	}
...
func (_q *ChatMessageQuery) loadConversation(ctx context.Context, query *ChatConversationQuery, nodes []*ChatMessage, init func(*ChatMessage), assign func(*ChatMessage, *ChatConversation)) error {
...
func (_q *ChatMessageQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*ChatMessage, init func(*ChatMessage), assign func(*ChatMessage, *User)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*ChatMessage)
	for i := range nodes {
		fk := nodes[i].UserID
...
func (_q *ChatMessageQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(chatmessage.Table, chatmessage.Columns, sqlgraph.NewFieldSpec(chatmessage.FieldID, field.TypeInt64))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withConversation != nil {
			_spec.Node.AddColumnOnce(chatmessage.FieldConversationID)
		}
		if _q.withUser != nil {
