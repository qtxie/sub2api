...
func (_u *UserUpdate) SetSessionStorageEnabled(v bool) *UserUpdate {
	_u.mutation.SetSessionStorageEnabled(v)
	return _u
}

// SetNillableSessionStorageEnabled sets the "session_storage_enabled" field if the given value is not nil.
func (_u *UserUpdate) SetNillableSessionStorageEnabled(v *bool) *UserUpdate {
	if v != nil {
		_u.SetSessionStorageEnabled(*v)
	}
	return _u
}
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.SessionStorageEnabled(); ok {
...
// SetSessionStorageEnabled sets the "session_storage_enabled" field.
func (_u *UserUpdateOne) SetSessionStorageEnabled(v bool) *UserUpdateOne {
	_u.mutation.SetSessionStorageEnabled(v)
	return _u
}

// SetNillableSessionStorageEnabled sets the "session_storage_enabled" field if the given value is not nil.
func (_u *UserUpdateOne) SetNillableSessionStorageEnabled(v *bool) *UserUpdateOne {
	if v != nil {
		_u.SetSessionStorageEnabled(*v)
	}
	return _u
