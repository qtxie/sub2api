...
func provideCleanup(
	...
	return func() {
		...
		parallelSteps := []cleanupStep{
			...
			{"SessionArchiveService", func() error {
				if sessionArchive != nil {
					return sessionArchive.Shutdown(ctx)
				}
				return nil
			}},
			...
			{"VideoStudioTracker", func() error {
				if videoStudioTracker != nil {
					videoStudioTracker.Stop()
				}
				return nil
			}},
