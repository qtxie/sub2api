...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	chatHandler := handler.NewChatHandler(chatService, apiKeyService, gatewayService, configConfig)
	imagePlaygroundHandler := handler.NewImagePlaygroundHandler(apiKeyService, gatewayService, configConfig)
	...
	openAIGatewayService := service.NewOpenAIGatewayService(accountRepository, usageLogRepository, usageBillingRepository, userRepository, userSubscriptionRepository, userGroupRateRepository, gatewayCache, configConfig, schedulerSnapshotService, concurrencyService, billingService, rateLimitService, billingCacheService, httpUpstream, deferredService, openAITokenProvider, grokTokenProvider, modelPricingResolver, channelService, balanceNotifyService, settingService, serviceUserPlatformQuotaRepository, proxyRepository, proxyLatencyCache)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, chatHandler, imagePlaygroundHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, batchImageHandler, idempotencyCoordinator, idempotencyCleanupService)
